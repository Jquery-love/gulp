    ...
    if (ext === '.json') {
        ...
        if (_.isObject(json)) {
            ...
            Object.keys(json).forEach(function (key) {
                // console.log(path.basename(json[key]).replace(new RegExp( opts.revSuffix ), '' ),path.basename(key));
...
function revCollector(opts) {
    ...
    return through.obj(function (file, enc, cb) {
        ...
        for (var key in manifest) {
            ...
            var patterns = [ escPathPattern(key)+'(\\?v=[0-9a-f]{8,12}|)' ];
            ...
            if ( dirReplacements.length ) {
                dirReplacements.forEach(function (dirRule) {
                    patterns.forEach(function (pattern) {
                        ...
                        // console.log(new RegExp(  dirRule.dirRX + pattern, 'g' ),(dirRule.dirRX + pattern).length,dirRule.dirRpl(manifest[key]));
                    });
                });
            } else {
                patterns.forEach(function (pattern) {
